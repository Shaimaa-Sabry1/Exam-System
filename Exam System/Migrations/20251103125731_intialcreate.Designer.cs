...
namespace Exam_System.Migrations
{
    ...
    [Migration("20251103125731_intialcreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exam_System.Domain.Entities.Selectedchoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AnswerDetailsId", "choiceId");

                    b.ToTable("SelectedChoices", (string)null);
                });
            ...
            modelBuilder.Entity("Exam_System.Domain.Entities.Selectedchoice", b =>
                {
                    b.HasOne("Exam_System.Domain.Entities.AnswerDetail", "answerDetails")
                        .WithMany("Selectedchoices")
                        .HasForeignKey("AnswerDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
